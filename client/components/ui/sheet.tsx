...
function SheetOverlay({
  ...
  return (
    // Overlay: use modal z-level (z-40) to align with dialog/modal scale
...
function SheetContent({
  ...
  return (
    <SheetPortal>
      <SheetOverlay />
      {/* Sheet content: modal-level (z-40) so it sits above sidebar/content but below toast/tooltips */}
